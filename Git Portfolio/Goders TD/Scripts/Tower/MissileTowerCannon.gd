...
#MISSILE TOWER SPECIFIC INIT
var blastRadius = 150
var target_position
var heat_seeking = false
var shot = preload("res://Scenes/Towers/Projectiles/MissileProjectile.tscn")
...
func shoot():
	...
	x.set_target(target, muzzle, rotation, effective_attack_speed, effective_attack_damage, heat_seeking, blastRadius, element_type, effective_element_level, hit_flyers, hit_stealth)
